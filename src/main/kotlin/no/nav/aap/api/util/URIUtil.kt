...
object URIUtil {
    ...
    private fun builder(base: URI, path: String, queryParams: HttpHeaders?): UriComponentsBuilder = UriComponentsBuilder.fromUri(base).pathSegment(path).queryParams(queryParams)
