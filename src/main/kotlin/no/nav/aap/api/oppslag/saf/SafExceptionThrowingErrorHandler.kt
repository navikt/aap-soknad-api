...
@Component
private class SafExceptionThrowingErrorHandler : SafErrorHandler {
    private val log = LoggerUtil.getLogger(javaClass)
    private val secureLogger = LoggerUtil.getSecureLogger()

    override fun <T> handleError(e: GraphQLErrorsException): T {
        log.warn("SAF feilet, se secure logs for mer detaljer")
        secureLogger.error("SAF oppslag returnerte ${e.errors.size} feil. ${e.errors}", e)
