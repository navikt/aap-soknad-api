...
data class MinSideConfig(@NestedConfigurationProperty private val nais: NAISConfig,
    ...
    data class UtkastConfig( @DefaultValue("min-side.aapen-utkast-v1") val topic: String, @DefaultValue("true") val enabled: Boolean,@DefaultValue("false")  val sendenabled: Boolean)
