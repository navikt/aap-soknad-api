...
public class TokenUtil {
    ...
    public String getSubject() {
        return getSubject(AbstractRestConfig.ISSUER);
    }
    ...
    private JwtTokenClaims claimSet() {
        return claimSet(AbstractRestConfig.ISSUER);
    }
    ...
    public boolean erAutentisert() {
        return erAutentisert(AbstractRestConfig.ISSUER);
    }
    ...
    public String getToken() {
        return getToken(AbstractRestConfig.ISSUER);
    }
    ...
    public JwtToken getJWTToken() {
        return getJWTToken(AbstractRestConfig.ISSUER);
    }
